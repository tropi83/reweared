...
| **Copy**           | Title (≤ 70 chars), description, condition, colour, brand (the seller's, verbatim, or the one readable on the photo) and keywords written from the original photo by a vision model — Gemini 3.1 Flash-Lite by default (cheapest available, free tier), switchable to other Gemini Flash models or Cloudflare Llama vision models — editable and copyable                                                                                                               |
