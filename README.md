...
| **Listing packs** | Category → subcategory → four predefined shots per product kind (56 packs, 40 kinds). No free prompt; prompts can be tweaked per run. Custom recipes remain available                                  |
