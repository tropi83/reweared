...
export const fr: Partial<Record<keyof typeof en, string>> = {
  ...
  "listings.empty.title": "Aucune annonce pour l'instant",
  "listings.empty.body": "Importez une photo de l'article pour créer votre première annonce. Tout reste sur cet appareil.",
  "listings.untitled": "Annonce sans titre",
  "listings.delete.title": "Supprimer l'annonce ?",
  "listings.delete.body": "« {name} » et toutes ses images seront supprimées de cet appareil. Cette action est irréversible.",
  "listings.rename.title": "Renommer l'annonce",
  ...
  "generation.emptyBody": "Choisissez la catégorie de votre article, puis « Créer l'annonce » : les photos apparaissent ici une par une.",
  "generation.regenerateShot": "Regénérer cette photo",
  "generation.useAsSource": "Utiliser comme source",
  "generation.sourceSet": "Source mise à jour : la prochaine annonce sera générée à partir de cette photo.",
  ...
  "storage.usage": "{count} annonces · {size}",
  "storage.clearAll": "Supprimer toutes les données locales",
  "storage.clearAll.body": "Toutes les annonces, images et réglages de cet appareil seront supprimés, ainsi que les identifiants.",
  "storage.cleanup": "Supprimer les fichiers orphelins",
  "storage.cleanupDone": "{count} fichiers orphelins supprimés",
  "storage.export": "Exporter l'archive de l'annonce",
  "privacy.body":
    "Vos annonces, images, prompts et historique restent sur cet appareil. Une image ne quitte votre appareil que lorsque vous lancez une génération ; elle est alors envoyée directement au fournisseur d'IA configuré. Aucune analyse n'envoie vos images ou vos prompts ailleurs.",
  ...
  "error.cloudflare.CONTENT_REJECTED":
    "Le filtre de sécurité de Cloudflare a bloqué cette image — un logo de marque en gros plan est le déclencheur habituel. Les essais suivants utilisent une nouvelle seed, puis un prompt qui ne demande plus de conserver logos et textes. Réessayez, ou cadrez l'article pour que le logo soit plus petit.",
  ...
  "error.MODEL_UNAVAILABLE": "Ce modèle n'est pas disponible pour votre compte (retiré ou restreint). Choisissez un autre modèle dans les Réglages.",
  ...
  "publish.bar.login": "Connectez-vous à Vinted (e-mail, Facebook ou Apple — pas Google), puis ouvrez le formulaire de vente.",
  "publish.bar.browse": "Ouvrez le formulaire de vente (Vendre) : les photos sont attachées, le texte est collé quand vous cliquez les icônes.",
  "publish.bar.filling": "Remplissage du formulaire…",
  "publish.bar.ready": "Photos {attached}/{requested} · Titre {title} · Description {description} — cliquez les icônes ⧉ pour coller le texte.",
  "publish.bar.filled": "Titre {title} · Description {description} · Photos {attached}/{requested} — vérifiez, puis cliquez « Ajouter » vous-même.",
  "publish.bar.notForm": "Cette page n'est pas le formulaire de vente.",
  "publish.bar.timeout": "Le formulaire n'a pas répondu. Rechargez la page pour réessayer.",
  ...
  "listing.brandHint": "facultatif",
  "listing.brandPlaceholder": "ex. Nike — laissez vide s'il n'y en a pas",
  "listing.advanced": "Options avancées",
  "listing.createPlain": "Créer l'annonce",
  "listing.create": "Créer l'annonce · {count} photos + texte",
  "listing.createPhotos": "Créer l'annonce · {count} photos",
  "listing.createText": "Créer l'annonce · texte",
  "listing.recreate": "Recréer l'annonce",
  "listing.recreate.title": "Recréer l'annonce ?",
  "listing.recreate.body": "De nouvelles photos s'ajoutent à l'historique ; le titre et la description sont remplacés.",
  "listing.creating": "Création de l'annonce…",
  "listing.skipPhotos": "Photos ignorées : connectez un fournisseur d'images dans les Réglages.",
  "listing.skipText": "Texte ignoré : connectez {provider} dans les Réglages.",
  ...
  "copy.regenerateText": "Régénérer le texte",
  ...
  "copy.attr.condition": "État : {value}",
  "copy.attr.brand": "Marque : {value}",
  "copy.attr.color": "Couleur : {value}",
