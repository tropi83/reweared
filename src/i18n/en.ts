export const en = {
  ...
  "generation.emptyBody": "Choose the category of your item, then “Create the listing”: the photos appear here one by one.",
  "generation.regenerateShot": "Generate this photo again",
  "generation.useAsSource": "Use as source",
  "generation.sourceSet": "Source updated: the next listing will be generated from this photo.",
  ...
  "error.cloudflare.CONTENT_REJECTED":
    "Cloudflare's safety filter blocked this image — a brand logo in close-up is the usual trigger. Retries use a new seed, then a prompt that no longer asks to keep logos and text. Retry, or frame the item so the logo is smaller.",
